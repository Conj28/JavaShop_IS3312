 ...
 * @author Conor
 */
public class ShowProductItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Product product = productDAO.getCurrentProd(currentID);
          
           request.getSession(true).setAttribute("ProductItem", product); 
            
           
          
           
           RequestDispatcher rd = request.getRequestDispatcher("/product-item.jsp");
